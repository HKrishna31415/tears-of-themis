...
export default function SecretumSecretorumDetails() {
  const secretum = new SecretumSecretorum()
  return (
    <div className="details pt-5">
      <Container>
        <Title>
          <h1>| Romantic Rail Getaway Part II</h1>
        </Title>
        <SubheadingSeparator
        ...
        <Row>
          <DetailsBox
            ...
            isWeapon={true}
            src={'brewing-thoughts.png'}
          />
          <DetailsBox
            title={'From Benevolent Rains to Clear Days'}
            isWeapon={true}
            src={'from-benevolent-rains-to-clear-days.png'}
          />
        </Row>
        ...
        <Row>
          <Col xs="12">
            <p className="my-3">
              ...
              cards{" "}
              <span className="brass">Brewing Thoughts (Vyn)</span> {" "}
              or <span className="brass">From Benevolent Rains to Clear Days (Artem)</span> will get a{" "}
            ...
            or <span className="brass">From Benevolent Rains to Clear Days (Artem)</span>.
            </p>
