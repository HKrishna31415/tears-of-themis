...
export default function BalladsInGobletsDetails() {
  ...
  return (
    <div className="details pt-5">
      <Container>
        <Title>
          <h1>| <span className="blue">Xia Yan</span> Birthday</h1>
        </Title>
        <SubheadingSeparator
        ...
        <Row>
          <Col xs="12">
            <p className="my-3">
              "<span className="blue">Xia Yan's Birthday</span>" is
              now available. <br />
              ...
              <span className="brass">Warm Embrace (Luke)</span> as well as
              the SSR cards{" "}
            ...
            <p className="my-3">
            For Shadow of Themis "<span className="blue">Xia Yan's Birthday</span>{" "}
            ...
            <span className="brass">
              {" "}
              <span className="brass">Warm Embrace (Luke)</span>
            </span>{" "}
