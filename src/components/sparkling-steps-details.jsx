...
export default function SparklingStepsDetails() {
  const sparkling = new SparklingSteps()
  return (
    <div className="details pt-5">
      <Container>
        <Title>
          <h1>| <span className="purple">Lu Jinghe</span> Birthday</h1>
        </Title>
        <SubheadingSeparator
        ...
        <Row>
          <Col xs="12">
            <p className="my-3">
              "<span className="purple">Lu Jinghe's Birthday</span>" is
              now available. <br />
              ...
              <span className="brass">Lights and Scenery (Marius)</span> as well as
              the SSR cards{" "}
            ...
            <p className="my-3">
            For Shadow of Themis "<span className="purple">Lu Jinghe's Birthday</span>{" "}
            ...
            <span className="brass">
              {" "}
              <span className="brass">Lights and Scenery (Marius)</span>
            </span>{" "}
