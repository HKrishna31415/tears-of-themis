...
export default class Banners extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      banners: {
        'beginners-wish': 'Novice Banner',
        [selectedCharacterEventWish]: 'Event Banner',
        'epitome-invocation': 'CN Current Event Banner',
        'wanderlust-invocation': 'Shadows of Themis'
      },
      wishes: {
  ...
  toggleBeginnersWish(isLimited) {
    if (isLimited) {
      this.setState({
        ...
        banners: {
          [this.props.getFormattedCharacterEventWish('kebabCase')]: 'Event Banner',
          'epitome-invocation': 'Current CN Event Banner',
          'wanderlust-invocation': 'Shadows of Themis'
        },
        wishes: {
