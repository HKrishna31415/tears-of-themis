...
export default function FarewellOfSnezhnayaDetails() {
  ...
  return (
    <div className="details pt-5">
      <Container>
        <Title>
          <h1>| <span className="red">Zuo Ran</span> Birthday</h1>
        </Title>
        <SubheadingSeparator
        ...
        <Row>
          <Col xs="12">
            <p className="my-3">
              "<span className="red">Zuo Ran's Birthday</span>" is
              now available. <br />
              ...
              <span className="brass">Hearts as One (Artem)</span> as well as
              the SSR cards{" "}
            ...
            <p className="my-3">
            For Shadow of Themis "<span className="red">Zuo Ran's Birthday"</span>{" "}
            ...
            <span className="brass">
              {" "}
              <span className="brass">Hearts as One (Artem)</span>
            </span>{" "}
