...
export default function GentryOfHermitageDetails() {
  ...
  return (
    <div className="details pt-5">
      <Container>
        <Title>
          <h1>| <span className="brass">Mo Yi</span> Birthday</h1>
        </Title>
        <SubheadingSeparator
        ...
        <Row>
          <DetailsBox
            ...
            isWeapon={true}
            src={'a-star-in-the-night.png'}
          />
          <DetailsBox
            title={'Bindings of the Past'}
            isWeapon={true}
            src={'bindings-of-the-past.png'}
          />
        </Row>
        <StarsBar
          starCount={5}
        ...
        <Row>
          <Col xs="12">
            <p className="my-3">
              "<span className="brass">Mo Yi's Birthday</span>" is
              now available. <br />
              ...
              <span className="brass">A Star in the Night (Vyn) and Bindings of the Past (Vyn)</span> as well as
              the SSR cards{" "}
            ...
            <p className="my-3">
            For Shadow of Themis "<span className="blue">Mo Yi's Birthday</span>{" "}
            ...
            <span className="brass">
              {" "}
              <span className="brass">A Star in the Night (Vyn) or Bindings of the Past (Vyn)</span>
            </span>{" "}
            ...
            <p className="my-3">
            For Shadow of Themis "<span className="brass">Mo Yi's Birthday</span>{" "}
