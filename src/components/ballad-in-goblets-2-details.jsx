...
export default function BalladInGoblets2Details() {
  ...
  return (
    <div className="details pt-5">
      <Container>
        <Title>
          <h1>| Kiss of Fervor: <span className="blue">Raven</span></h1>
        </Title>
        <SubheadingSeparator
        ...
        <Row>
          <DetailsBox
            title={'Falling Galaxies in the Night'}
            isWeapon={true}
            src={'falling-galaxies-in-the-night.png'}
          />
        </Row>
        <StarsBar
          starCount={5}
        ...
        <Row>
          <DetailsBox
            title={"Alluring Gaze"}
            isWeapon={true}
            src={"alluring-gaze.png"}
          />
          <DetailsBox
            title={"Perfect Partner"}
            isWeapon={true}
            src={"perfect-partner.png"}
          />
        </Row>
        ...
        <Row>
          <Col xs="12">
            <p className="my-3">
              "<span className="blue">Kiss of Fervor: Raven</span>" is
              now available. <br />
              ...
              <span className="brass">Falling Galaxies in the Night (Luke)</span> as well as
              the SSR cards{" "}
              <span className="brass">Alluring Gaze (Luke)</span>,{" "}
              <span className="brass">Perfect Partner (Luke)</span> will be available.
              <br />
            </p>
            <p className="my-3">〓Rules〓</p>
            <p className="my-3">SSR Cards</p>
            <p className="my-3">
            For Shadow of Themis "<span className="blue">Kiss of Fervor: Raven</span>{" "}
            ...
            <span className="brass">
              {" "}
              <span className="brass">Falling Galaxies in the Night (Luke)</span>
            </span>{" "}
            or a 20% chance it will be one of the non featured SSR cards:{" "}
            <span className="brass">Alluring Gaze (Luke)</span> or {" "}
            <span className="brass">Perfect Partner (Luke)</span>
